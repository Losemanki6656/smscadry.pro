        ...
        <div class="form-inline">
          <div class="form-group mx-sm-3 mb-2">
             <form action="{{route('home')}}" method="get">
                    @csrf
                    <input class="form-control" value="{{request()->query('search')}}" name="search" type="search" placeholder="search ..." />
              </form>
          </div>
          <button type="button" class="btn  btn-primary mb-2" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-plus mr-2"></i>Add Worker</button>
        </div>
                ...
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="phone" class="form-control phone" name="phone"  required style="width: 100%;">
                    </div>
                    <div class="form-group">
