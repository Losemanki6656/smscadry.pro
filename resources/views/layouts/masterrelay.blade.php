    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                     <a href="{{route('home')}}" class="nav-link "><span class="pcoded-micon"><i class="fa fa-users"></i></span><span class="pcoded-mtext">Relays</span></a>
                </li>
               <li class="nav-item">
               ...
               <li class="nav-item">
                     <a href="{{route('numbers')}}" class="nav-link "><span class="pcoded-micon"><i class="fa fa-check"></i></span><span class="pcoded-mtext">Phone Numbers</span></a>
               </li>
               
               <li class="nav-item">
                     <a href="{{route('commentrelays')}}" class="nav-link "><span class="pcoded-micon"><i class="fa fa-check"></i></span><span class="pcoded-mtext">Comments</span></a>
               </li>
