    ...
    <div class="card table-card">
      <div class="card-header">
        ...
        <div class="form-inline">
          ...
          <button type="submit" class="btn  btn-primary mb-2" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-plus mr-2"></i>Add Number</button>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle">Add Number</h5>
